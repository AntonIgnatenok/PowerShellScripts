...
# Specify the User account for an SharePoint Online admin or Global admin in your organization
$AdminAccount = "Admin@contoso.com"
$AdminPass = ConvertTo-SecureString -string "P@ssw0rd" -AsPlainText -Force

# Specify the secondary admin account and the url for the onedrive site
$secondaryadmin = "SecondaryAdmin@contoso.com"
$siteURI = "https://contoso-my.sharepoint.com"
...
While ($UserProfileResult.NextValue -ne -1){
    ...
    if($Url){
        ...
        Write-Host "Remove secondary admin from the site $($sitename)"
    }
